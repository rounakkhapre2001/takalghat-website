    ...
    <div className="w-full bg-gradient-to-br from-orange-200 via-white to-green-200">
      ...
      <section className="relative w-full h-[400px] md:h-[800px]">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-white text-center px-4">
          <h1 className="text-4xl md:text-6xl font-bold">{t.aboutTitle}</h1>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 text-center px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          <p className="text-lg md:text-2xl text-green-900 leading-relaxed">
            {t.aboutText}
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-6">
        <div className="max-w-7xl mx-auto text-center">
          <p className="uppercase text-sm md:text-base text-green-900 font-semibold mb-2">
            {t.challenge}
          </p>
          <h2 className="text-3xl md:text-5xl font-bold text-green-900 mb-4">
            {t.offerTitle}
          </h2>
          <p className="max-w-xl mx-auto text-gray-800 mb-12 text-lg md:text-2xl">
            {t.offerDesc}
          </p>
