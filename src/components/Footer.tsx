...
const Footer = () => {
  ...
  return (
    <footer className="bg-green-900 text-white font-poppins py-10 px-3">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-y-8 md:gap-x-12">
        ...
        <div className="flex flex-col w-full md:w-1/2 mb-8 md:mb-0">
          <div className="text-center md:text-left">
            <div className="font-extrabold text-2xl mb-1">{t.footer.title}</div>
            <div className="font-semibold text-lg mb-2">{t.footer.subtitle}</div>
          </div>
          <div className="flex gap-7 mt-3 justify-center md:justify-start">
            <img src="/logo1_footer-removebg.png" alt="Seal" className="h-18 w-auto" />
            <img src="/mohatsav-removebg-preview.png" alt="Azadi" className="h-18 w-auto" />
            <img src="/footer3-removebg-preview.png" alt="Swachh" className="h-18 w-auto" />
            <img src="/footer4-removebg-preview.png" alt="Digital India" className="h-14 w-auto" />
          </div>
          <div className="mt-10 text-center md:text-left">
            <div className="font-bold text-4xl mb-4">{t.footer.social}</div>
            <div className="flex space-x-8 text-2xl justify-center md:justify-start">
        ...
        <div className="flex flex-col w-full md:w-1/2">
          <div className="text-4xl font-bold mb-7 text-center md:text-left">{t.footer.country}</div>
      ...
      {/* Bottom Bar */}
      <div className="w-full flex justify-center mt-10 pt-5 border-t border-[#3a3e6e] text-gray-400 text-lg select-none">
        <span>{t.footer.copyright}</span>
        <span className="mx-1 text-purple-700 font-bold text-base">©</span>
        <span className="mx-1">
          {t.footer.rights}
