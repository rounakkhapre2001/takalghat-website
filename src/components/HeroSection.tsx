...
import { LanguageContext } from "@/context/LanguageContext"; // सही से import करो

const HeroSection = () => {
  const { t } = useContext(LanguageContext); // यही use करना है
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="hidden md:flex md:flex-col md:items-center md:justify-center w-full h-full">
        ...
        <motion.div
          className="absolute top-58 right-94 w-50 h-60"
          animate={{ rotate: 360 }}
        ...
        <div className="relative text-center px-6 mt-20">
          ...
          <p className="mt-6 text-gray-200 max-w-2xl mx-auto text-xl md:text-2xl">
            {t.heroDesc}
          </p>
          <Link
            href="/contact"
            className="mt-8 px-10 py-5 bg-green-900 text-white font-semibold text-lg md:text-xl rounded-full shadow-lg hover:bg-green-800 transition block w-fit mx-auto"
          >
            {t.bookAppointment} →
          </Link>
        </div>
      ...
      <div className="block md:hidden w-full h-full flex flex-col items-center justify-start pt-16">
        ...
        <div className="relative text-center px-6 mt-8">
          ...
          <p className="mt-4 text-gray-200 max-w-2xl mx-auto text-base">
            {t.heroDesc}
          </p>
          <Link
            href="/contact"
            className="mt-6 px-6 py-3 bg-green-900 text-white font-semibold rounded-full shadow-md hover:bg-green-800 transition block w-fit mx-auto"
          >
            {t.bookAppointment} →
          </Link>
        </div>
